...
final class EditorialController extends Controller
{
    public function index(ArticleFilterRequest $request): AnonymousResourceCollection
    {
        ...
        return ArticleAdminResource::collection(
    ...
    private function data(array $validated): PostData
    {
        return new PostData(
            ...
            excerpt: array_key_exists('excerpt', $validated) && is_string($validated['excerpt']) ? $validated['excerpt'] : null,
            body: array_key_exists('body', $validated) && is_string($validated['body']) ? $validated['body'] : null,

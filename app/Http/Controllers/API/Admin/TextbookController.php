...
final class TextbookController extends Controller
{
    public function index(BookFilterRequest $request): AnonymousResourceCollection
    {
        ...
        return BookAdminResource::collection(
    ...
    private function data(array $validated): BookData
    {
        return new BookData(
            ...
            shortDescription: array_key_exists('shortDescription', $validated) && is_string($validated['shortDescription']) ? $validated['shortDescription'] : null,
            description: array_key_exists('description', $validated) && is_string($validated['description']) ? $validated['description'] : null,
